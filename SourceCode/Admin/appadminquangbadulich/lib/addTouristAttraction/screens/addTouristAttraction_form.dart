...
class _AddTouristAttractionFormState extends State<AddTouristAttractionForm> {
  ...
  Future<void> _updateImage() async {
    if (imagePathTouristAttraction != null &&
      ...
      print('day la ====> $base64DataTouristAttraction');
      print('day la ====> $base64DataAvatarHistory');
      print('day la ====> $base64DataimgHistory');
      print('day la ====> $base64DataimgCulture');
      print('day la ====> $base64DataimgDish');
